...
from geospatial_engine.src.core_processor import SatQueryEngine
...
from geospatial_engine.src.ingestion.raster_loader import RasterDataLoader as GeoTIFFLoader
...
def index():
    ...
    return jsonify({
        ...
        "health": "/api/health",
        "docs": "https://github.com/Jaytavanoji/SatQuery-Ai.git"
    })
