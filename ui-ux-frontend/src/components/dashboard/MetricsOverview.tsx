  ...
  const metrics = [
    {
      ...
      trend: 'positive',
      // Cyan / Deep Navy Tint
      cardBg: 'bg-gradient-to-br from-[#07253a] via-[#091b33] to-[#050f1d]',
    ...
    },
    {
      ...
      cardBg: 'bg-gradient-to-br from-[#0d2354] via-[#0a1936] to-[#050f1d]',
      ...
      iconStyle: 'bg-blue-500/20 text-blue-300 border border-blue-500/40 shadow-xs',
    ...
    },
    {
      ...
      cardBg: 'bg-gradient-to-br from-[#072f2b] via-[#081e28] to-[#050f1d]',
    ...
    },
    {
      ...
      cardBg: 'bg-gradient-to-br from-[#2c1348] via-[#161238] to-[#050f1d]',
      ...
      {metrics.map((m, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className={`flex items-center gap-1 text-[11px] font-mono ${m.textColor} pt-2 border-t border-white/10 relative z-10`}>
