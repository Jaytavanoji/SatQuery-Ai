...
export const BenchmarkCardGrid: React.FC<BenchmarkCardGridProps> = ({ onSelectPreset }) => {
  const cards = [
    {
      ...
      // Land Cover: Teal
      cardBg: 'bg-gradient-to-br from-[#082933] via-[#0a1c33] to-[#061120]',
      borderStyle: 'border-teal-400/50 hover:border-teal-300',
      ...
      iconStyle: 'bg-teal-500/20 text-teal-300 border border-teal-500/40 shadow-xs',
    ...
    },
    {
      ...
      // Canopy: Rose / Crimson
      cardBg: 'bg-gradient-to-br from-[#311425] via-[#191535] to-[#081122]',
      ...
      iconStyle: 'bg-rose-500/20 text-rose-300 border border-rose-500/40 shadow-xs',
      orbGlow1: 'bg-rose-400/15',
      orbGlow2: 'bg-purple-500/10',
      accentHover: 'group-hover:text-rose-400'
    },
    {
      ...
      presetIndex: 1, // Rhine
      // Flood: Ocean Cyan
      cardBg: 'bg-gradient-to-br from-[#092a48] via-[#091e3b] to-[#061020]',
      borderStyle: 'border-cyan-400/50 hover:border-cyan-300',
      ...
      iconStyle: 'bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 shadow-xs',
    ...
    },
    {
      ...
      // Crop: Lime / Olive
      cardBg: 'bg-gradient-to-br from-[#1c2c15] via-[#0f2129] to-[#061020]',
      borderStyle: 'border-lime-400/50 hover:border-lime-300',
      ...
      iconStyle: 'bg-lime-500/20 text-lime-300 border border-lime-500/40 shadow-xs',
      orbGlow1: 'bg-lime-400/15',
      orbGlow2: 'bg-teal-400/10',
      accentHover: 'group-hover:text-lime-400'
    },
    {
      ...
      cardBg: 'bg-gradient-to-br from-[#261545] via-[#131b3e] to-[#061020]',
      ...
      iconStyle: 'bg-purple-500/20 text-purple-300 border border-purple-500/40 shadow-xs',
        ...
        {cards.map((card, idx) => {
          ...
          return (
            <button
              ...
              className={`relative text-left p-4 rounded-2xl ${card.cardBg} border ${card.borderStyle} ${card.glowStyle} transition-all duration-200 hover:-translate-y-1 active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 flex flex-col justify-between group overflow-hidden backdrop-blur-xl cursor-pointer`}
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className={`text-sm font-bold text-white ${card.accentHover} transition-colors`}>
                  {card.title}
                </h3>
              ...
              <div className="mt-4 pt-3 border-t border-white/10 flex items-center justify-between text-[11px] font-mono text-gray-400 group-hover:text-cyan-400 relative z-10 transition-colors">
...
export const QuickStartCards = BenchmarkCardGrid;
