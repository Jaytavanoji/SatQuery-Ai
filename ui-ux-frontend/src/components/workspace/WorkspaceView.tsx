...
export const WorkspaceView: React.FC<WorkspaceViewProps> = ({ initialAOI }) => {
  ...
  // Pane collapse state for maximum geospatial canvas flexibility
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-53px)] w-full overflow-hidden bg-black text-white">
      {/* Top Header */}
      <WorkspaceHeader
        activeAOI={activeAOI}
      ...
      <div className="flex-1 flex w-full overflow-hidden relative">
        ...
        >
          ...
          <button
            ...
            className="absolute -right-3 top-4 z-30 w-6 h-6 rounded-full bg-gray-900 border border-white/20 text-gray-300 hover:text-white hover:border-cyan-500/40 flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-transform cursor-pointer"
