...
class CrossModalSpecialist:
    ...
    def __init__(
        ...
        # Attempt pre-trained timm ViT backbone weight streaming
        try:
            import timm
            vit_m = timm.create_model("vit_base_patch16_224", pretrained=True, in_chans=14, num_classes=0)
            state_dict = vit_m.state_dict()
