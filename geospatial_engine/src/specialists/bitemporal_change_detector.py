...
from geospatial_engine.src.physics.spectral_calculators import compute_ndvi, compute_ndwi
...
class ChangeDetectionSpecialist:
    ...
    def __init__(
        ...
        # Attempt pre-trained torchvision ResNet-50 feature backbone initialization
        try:
            import torchvision.models as tv_models
            r50 = tv_models.resnet50(weights=tv_models.ResNet50_Weights.DEFAULT)
